...
cnf.add_specimen(2)               # 2
cnf.add_specimen(3)               # 3
cnf.s._alpha *= 4                 # 2
cnf.configure_time(10, 501, 10)      # 20 1001 10
...
cnf.configure_velocity_space(dimension=2,
                             ...
                             max_v=1.5)       # 1.5
cnf.collision_steps_per_time_step = 2     # 50
cnf.print()
...
ini.add_rule('Inner Point',
             ...
             [1, 1, 1],
             name='foo')
ini.apply_rule(0, [0], [100])
ini.add_rule('Inner Point',
             [4, 2, 1],
             [[0, 0], [0, 0], [0, 0]],
             [1, 1, 1],
             name='bar')
ini.apply_rule(1, [100], [200])
ini.print()
